...
namespace Visometry.VisionLib.SDK.Core
{
    ...
    public static class ModelSerialization
    {
        ...
        public class LoadedModelDescription
        {
            ...
            /// </summary>
            public WorkerCommands.CommandWarnings warnings;
        }
        ...
        public static async Task<List<ModelDeserializationResult>> AddMeshesAsync(
            ...
            bool useTexture)
        {
            var serializedModels = SerializeModels(CollectModelDataSetsInChildren(origin, useTexture));
            ...
            bool useLines = false)
        {
            ...
            return new LoadedModelDescription {name = uniqueUnityModelID, warnings = addModelWarnings};
        }
        ...
        private static List<ModelDataSet> CollectModelDataSetsInChildren(Transform origin, bool useTexture)
        {
