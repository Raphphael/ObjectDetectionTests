...
#pragma warning restore CS0618
        ISceneValidationCheck
    {
        ...
        {
            // Don't replace the stored value if it has not been restored yet.
        ...
        public async void OnInteractionEnded()
        {
            ...
            // If interaction has already started again, don't restore the value
            if (!this.isInteractionInProgress &&
            ...
            if (Camera.main != null)
            {
                solutions.Add(
                    new ReversibleAction(
                        () =>
                        {
                            this.trackingAnchor.SetSLAMCamera(Camera.main);
                            this.objectPoseInteractionProvider.SetInteractionCamera(Camera.main);
                        },
                        (Object) (this.objectPoseInteractionProvider),
                        "Use Main Camera in both components"));
            }
