...
namespace Visometry.VisionLib.SDK.Core
{
    public static class TrackingAnchorHelper
    {
        ...
        [Obsolete(
            "TrackingAnchorHelper.CreateUniqueName() is obsolete and will be removed in the future. Use TrackingAnchor.CreateUniqueName() instead")]
        ...
        public static void MergeAllTrackingAnchorAndSlamCameraPosesOnce()
        {
            var trackingAnchors = Object.FindObjectsOfType<TrackingAnchor>(true);

            var groupsBySlamCamera =
                trackingAnchors.GroupBy(trackingAnchor => trackingAnchor.GetSLAMCamera());
        ...
        private static void CloneAndStripAnythingButMeshes(Transform source, Transform destination)
        {
            ...
            var componentsToDestroy = destination.gameObject.GetComponentsInChildren<Component>().Where(IsNotMeshOrTransform);
        ...
        {
            return trackingAnchor.GetRegisteredRenderedObjects().Count > 0;
        }
