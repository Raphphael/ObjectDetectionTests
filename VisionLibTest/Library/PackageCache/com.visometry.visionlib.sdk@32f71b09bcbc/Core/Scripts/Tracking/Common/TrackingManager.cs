...
namespace Visometry.VisionLib.SDK.Core
{
    ...
    public abstract class TrackingManager : MonoBehaviour, IParameterHandler, ISceneValidationCheck
    {
        ...
        protected virtual void Awake()
        {
            ...
            TrackingAnchorHelper.MergeAllTrackingAnchorAndSlamCameraPosesOnce();
            Initialize();
        }
        ...
        [Obsolete(
            "Use the static function TrackingManager.DoesTrackerExistAndIsRunning instead.")]
        ...
        /// </remarks>
        [Obsolete(
            "Use the static function TrackingManager.DoesTrackerExistAndIsInitialized instead.")]
