...
namespace Visometry.VisionLib.SDK.Core.Details
{
    ...
    public static class CameraHelper
    {
        ...
        public static RenderRotation GetRenderRotation(ScreenOrientation orientation)
        {
            ...
            switch (orientation)
            {
                ...
                case ScreenOrientation.AutoRotation:
                    ...
                    return RenderRotation.CCW0;
                default:
                    NotificationHelper.SendError("Unknown orientation: " + orientation);
                    return RenderRotation.CCW0;
            }
#else
        ...
        public static ModelTrackerCommands.InitPose MatrixToGlobalObjectPose(Matrix4x4 globalObjectMatrix)
        {
