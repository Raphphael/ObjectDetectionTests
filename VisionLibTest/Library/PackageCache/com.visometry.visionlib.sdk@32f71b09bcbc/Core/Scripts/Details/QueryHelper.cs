...
namespace Visometry.VisionLib.SDK.Core
{
    ...
    public static class QueryHelper
    {
        ...
        {
            var queryParameters = GenerateImageSequenceInputQueryParameters(imageSequenceURI);
            if (simulateMobileRecording)
            {
                queryParameters.Add(
                    GenerateBooleanQuery(InputParameterNames.simulateMobileRecording, true));
            }
            if (ignoreImageSequenceIntrinsics)
            {
                queryParameters.Add(
