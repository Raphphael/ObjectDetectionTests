...
namespace Visometry.VisionLib.SDK.Core.API
{
    ...
    public class ModelTrackerCommands
    {
        ...
        /// </summary>
        public static async Task<CommandWarnings> SetRelativeInitPoseAsync(Worker worker, InitPose initPose)
        {
            return await worker.PushCommandAsync<CommandWarnings>(new SetRelativeInitPoseCmd(initPose));
        }
        ...
        {
            return await worker.PushCommandAsync<CommandWarnings>(new ResetParameterCmd(parameterName));
        }
        ...
        {
            private static readonly string defaultName = "setRelativeInitPose";
